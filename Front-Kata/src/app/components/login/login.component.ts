    ...
    <div class="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div class="w-full max-w-md bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <form class="p-6 space-y-4" [formGroup]="form" (ngSubmit)="onSubmit()">
          ...
          <button type="submit"
                  class="w-full inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-[#0b4dbb] text-white hover:bg-[#093d99] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0b4dbb] focus-visible:ring-offset-2">
            Iniciar sesión
